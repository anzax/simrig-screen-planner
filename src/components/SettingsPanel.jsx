  ...
  return (
    <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          {inputMode === 'diagonal' ? (
            ...
            <div className="space-y-3">
              ...
              <div className="bg-blue-50 border border-blue-200 rounded-lg py-1.5 px-2 text-xs text-blue-700">
                Measure total screen dimensions including bezels
              </div>
        ...
        <div className="bg-gray-50 rounded-lg p-3">
          <h3 className="text-sm font-medium text-gray-700 mb-2">Screen Setup</h3>
              ...
              {angleMode === 'auto' ? (
                <div className="bg-green-50 border border-green-200 rounded-lg py-1.5 px-2">
                  <div className="text-xs text-green-700">
                    Optimal angle: <span className="font-medium">{calculatedAngle}°</span>
                  </div>
                </div>
              ) : (
                <>
                  <div className="bg-yellow-50 border border-yellow-200 rounded-lg py-1.5 px-2 mb-1.5">
                    <div className="text-xs text-yellow-700">
                      Optimal: <span className="font-medium">{calculatedAngle}°</span>
                    </div>
                  </div>
                  <NumberInputWithSlider
                    label="Angle (degrees)"
